...
interface RentBotTextConstants {
    companion object {
        ...
        const val START = "У тебя получилось!:blush: Теперь давай красиво оформим твое предложение о сдачи апартаментов.\n" +
                "Используй команду: /${RentBotCommons.COMMAND_CREATE_POST}\n" +
                "Список всех команд: /${RentBotCommons.COMMAND_HELP}"
        ...
        const val CREATE_POST_TEXT = "Просто следуй инструкциям и бот сгенерирует отличнейшее предложение о сдачи апартаментов :thumbsup:\n\n" +
        ...
        const val ENTER_PRICE = "Введите месячную арендную стоимость апартаментов.:moneybag:\n" +
                "Также, укажите:\n" +
                "1. <b>Залоговую сумму</b>\n" +
                "2. Включены ли <b>комунальные услуги</b> в стоимость.\n" +
                "3. <b>Валюту</b>, в которой будет проводится оплата :exclamation:\n\n" +
