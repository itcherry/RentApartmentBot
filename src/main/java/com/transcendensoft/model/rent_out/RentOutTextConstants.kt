...
interface RentOutTextConstants {
    companion object {
        ...
        const val ENTER_REQUIRED_DATE = "Введите до когда вам нужно снять апартаменты.\n\n" +
                "Пример 1: Срочно.\n" +
                "Пример 2: До 1 июля.\n" +
                "Пример 3: Неспешно."
        const val ENTER_REQUIRED_LOCATION = ":world_map: Укажите раёны города, в котрых вы предпочитаете жить." +
        ...
        const val ENTER_REQUIRED_PRICE = "Введите бюджет, который можете позволить для месячной арендной платы апартаментов.:moneybag:\n" +
        ...
        const val LOAD_PHOTO_QUESTION = "Текстовая публикация создана. Вы хотите загрузить ваше фото или инфографику" +
                ...
                "\n\nШанс на то, чтобы снять апартаменты выше, если вы добавите фото :camera:"
